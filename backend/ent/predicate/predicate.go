...
// RedeemRule is the predicate function for redeemrule builders.
type RedeemRule func(*sql.Selector)
...
// UserRedeemStat is the predicate function for userredeemstat builders.
type UserRedeemStat func(*sql.Selector)
