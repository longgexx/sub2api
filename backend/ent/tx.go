...
func (tx *Tx) init() {
	...
	tx.BalanceSnapshotDaily = NewBalanceSnapshotDailyClient(tx.config)
	...
	tx.RedeemRule = NewRedeemRuleClient(tx.config)
	...
	tx.UserRedeemStat = NewUserRedeemStatClient(tx.config)
