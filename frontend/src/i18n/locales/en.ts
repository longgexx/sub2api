  ...
  keys: {
    ...
    useKeyModal: {
      ...
      permanentConfig: {
        ...
        step2: 'Paste and run in terminal',
        step3: 'Enter your API Key ({apiKey}) when prompted',
        step4: 'Reopen terminal or VS Code and run claude command to start using',
        note: 'The one-click setup script will automatically detect and clean up conflicting configurations, set both Shell environment variables and Claude settings.json, and take effect immediately.',
      },
      openai: {
    ...
    claudeCodeSetupModal: {
      title: 'Claude Code Quick Setup',
      description: 'Run the following command to configure Claude Code to connect to this service',
      macLinux: 'macOS / Linux',
      windows: 'Windows PowerShell',
      copy: 'Copy',
      copied: 'Copied',
      ...
      step1: 'Copy the command above',
      step2: 'Paste and run in terminal',
      step3: 'Enter your API Key when prompted',
      step4: 'Reopen terminal or run source command',
      apiKeyHint: 'Please create an API Key on this page first, then use it in the setup script',
    },
  },
