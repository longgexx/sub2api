export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      permanentConfig: {
        ...
        step1: '复制上方命令',
        step2: '在终端中粘贴执行',
        step3: '按提示输入您的 API Key（{apiKey}）',
        step4: '重新打开终端或 VS Code 等 IDE，运行 claude 命令开始使用',
        note: '一键配置脚本会自动检测并清理冲突配置，同时设置 Shell 环境变量和 Claude settings.json，配置完成后立即生效。',
      },
      openai: {
    ...
    claudeCodeSetup: 'Claude Code 配置',
    claudeCodeSetupModal: {
      title: 'Claude Code 快速配置',
      description: '运行以下命令一键配置 Claude Code 连接到本服务',
      macLinux: 'macOS / Linux',
      windows: 'Windows PowerShell',
      copy: '复制',
      copied: '已复制',
      ...
      step2: '在终端中粘贴执行',
      step3: '按提示输入 API Key',
      step4: '重新打开终端或运行 source 命令',
      apiKeyHint: '请先在本页面创建 API Key，然后在配置脚本中使用',
    },
  },
  ...
  redeem: {
    ...
    originalValue: '原价',
    actualValue: '实际到账',
    trialUsed: '您已享受过新用户试用优惠，后续试用码将按常规额度兑换。如需更多额度，欢迎正价充值！',
    confirmTitle: '确认兑换',
    confirmDegradedRedeem: '此兑换码将以降级金额到账，是否继续？',
    confirmRedeem: '确认兑换',
    redeemCanceled: '已取消兑换'
  },

  // Payment / Topup
  payment: {
    title: '充值',
    description: '使用支付宝充值账户余额',
    currentBalance: '当前余额',
    notEnabled: '充值功能未启用',
    notEnabledHint: '管理员尚未开启支付功能，请联系管理员获取帮助。',
    topupAmount: '充值金额',
    customAmount: '自定义金额',
    customAmountPlaceholder: '输入金额',
    amountRange: '金额范围：{min} - {max}',
    estimatedPayment: '预计支付：¥{amount}',
    minAmount: '最小金额',
    maxAmount: '最大金额',
    quickAmounts: '快捷金额',
    createOrder: '创建订单',
    ...
    amount: '充值金额',
    paymentAmount: '需支付金额',
    paymentAmountHint: '请使用支付宝扫描下方二维码，支付 {amount} 元',
    payExactAmount: '请务必支付上述精确金额，否则无法自动到账！',
    actualCreditHint: '您实际支付多少就充值多少，尾数差异是为了区分订单',
    scanToPay: '扫码支付',
    scanToPayHint: '请使用支付宝扫描二维码',
    scanQrCode: '扫码支付',
    qrCodeHint: '请使用支付宝扫描二维码完成支付',
    orderExpires: '剩余支付时间',
    timeRemaining: '剩余时间',
    expired: '已过期',
    checkingStatus: '检查支付状态...',
    paymentSuccess: '支付成功！',
    paymentSuccessHint: '您的余额已更新',
    balanceAdded: '余额增加',
    balanceUpdated: '余额已增加 ${amount}',
    orderExpired: '订单已过期',
    orderExpiredHint: '请重新创建订单',
    cancelOrder: '取消订单',
    cancelling: '取消中...',
    ...
    noOrders: '暂无充值记录',
    instructions: '充值须知',
    instruction1: '请使用支付宝扫描二维码完成支付',
    instruction2: '支付金额必须与显示金额完全一致，否则无法自动到账',
    instruction3: '支付成功后，余额将在 1-2 分钟内自动到账',
    instruction4: '如遇问题，请联系客服并提供订单号',
    requested: '请求',
    actualPaid: '实付',
    status: {
      pending: '待支付',
    ...
    errors: {
      loadConfigFailed: '加载支付配置失败',
      createOrderFailed: '创建订单失败',
      cancelOrderFailed: '取消订单失败',
      loadOrdersFailed: '加载订单列表失败',
      amountRequired: '请输入充值金额',
      amountTooSmall: '充值金额不能小于 {min}',
      amountTooLarge: '充值金额不能大于 {max}'
    }
  },
  ...
  admin: {
    ...
    redeemRules: {
      title: '兑换规则',
      description: '管理试用码兑换限制规则',
      descriptionDetail: '通过规则控制特定面值兑换码的使用次数，超出后自动降级为较低面值。',
      createRule: '创建规则',
      editRule: '编辑规则',
      deleteRule: '删除规则',
      deleteRuleConfirm: '确定要删除此规则吗？删除后，相关面值的兑换码将不再有使用次数限制。',
      columns: {
        type: '类型',
        triggerValue: '触发面值',
        maxTimes: '原价次数',
      ...
      codeType: '兑换码类型',
      triggerValue: '触发面值',
      triggerValueHint: '当用户兑换此面值的兑换码时触发规则',
      maxTimesPerUser: '每用户原价次数',
      maxTimesHint: '每个用户可以按原价兑换的次数',
      fallbackValue: '降级面值',
      fallbackValueHint: '超出次数后，按此面值兑换',
      ruleDescription: '规则说明',
      descriptionPlaceholder: '例如：5元试用码限制，每用户限1次原价',
      enableRule: '启用规则',
      times: '次',
      ruleCreated: '规则创建成功',
      ruleUpdated: '规则更新成功',
    ...
    payment: {
      ...
      manualConfirmHint: '确定要手动确认订单 {trade_no} 已支付 ${amount} 吗？这将为用户增加相应余额。',
      confirmPayment: '确认支付',
      confirmSuccess: '订单已确认支付',
      confirmFailed: '确认支付失败',
      loadFailed: '加载订单失败',
      monitorService: '监控服务',
      running: '运行中',
      stopped: '已停止',
    ...
    settings: {
      ...
      payment: {
        title: '支付设置',
        description: '配置支付二维码和充值系数',
        qrCode: '支付宝收款码',
        uploadQRCode: '上传收款码',
        qrCodeHint: '建议上传清晰的支付宝经营码或个人收款码，最大 500KB',
        qrCodeSizeError: '图片大小不能超过 500KB',
        qrCodeTypeError: '请上传图片文件',
        qrCodeReadError: '读取图片失败',
        rateCoefficient: '充值系数',
        rateCoefficientHint: '示例：充值 $10 实际需支付 ¥{example}'
      },
      smtp: {
        title: 'SMTP 设置',
